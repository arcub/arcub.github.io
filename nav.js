...
bindNavigation +=            "<li><a href='http://freshers.aberrobotics.club/'>FRESHERS WEEK</a></li>";
...
bindNavigation +=          "<span class='caret'></span></a>";
bindNavigation +=          "<ul class='dropdown-menu'>";
bindNavigation +=        "<li><a href='http://students.aberrobotics.club/projects'>PROJECTS LIST</a></li>";
bindNavigation +=			 "<li><div class='divider'></li>";
